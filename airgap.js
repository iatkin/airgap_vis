...
class AirGapVisualization {
    static defaultRefreshInterval = 360000
    static defaultStaleData = 1800000

    constructor(elementID, options) {
        if (!options.refreshInterval) {
            options.refreshInterval = this.constructor.defaultRefreshInterval
        }
        if (!options.staleData) {
            options.staleData = this.constructor.defaultStaleData
        }
...
class WaterGageVisualization extends AirGapVisualization { 
    static defaultRefreshInterval = 900000
    static defaultStaleData = 7200000
...
export {AirGapVisualization, WaterGageVisualization}
